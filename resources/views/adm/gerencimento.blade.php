<x-app-layout>
    ...
    <style>
        <div class="py-12"><div class="max-w-7xl mx-auto sm:px-6 lg:px-8"><div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg"><div class="p-6 text-gray-900 dark:text-gray-100">.mini-foto {
            width: 80px;
            height: 50px;
            object-fit: cover;
        }
            ...
            <div class="row mb-4">
                <div class="col-md-6 mx-auto">
                    <div class="input-group">
                        <input type="text" class="form-control" id="searchCity" placeholder="Pesquisar cidade..."
                            aria-label="Pesquisar cidade" aria-describedby="searchButton">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped" id="citiesTable">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center align-middle">
                                <td>3</td>
                                <td><img src="imagens/cards/rio-de-janeiro.jpg" class="mini-foto" alt="Rio de Janeiro">
                                </td>
